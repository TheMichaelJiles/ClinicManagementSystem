namespace ClinicManagementSystem.View.UserControls
{
	partial class PatientAppointmentsControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.manageButton.Location = new System.Drawing.Point(707, 119);
			this.manageButton.Name = "manageButton";
			this.manageButton.Size = new System.Drawing.Size(152, 36);
			this.manageButton.TabIndex = 38;
			this.manageButton.Text = "Manage";
			this.manageButton.UseVisualStyleBackColor = false;
			this.manageButton.Click += new System.EventHandler(this.manageButton_OnClick);
			// 
			// createButton
			// 
			...
			this.apptDataGrid.RowHeadersWidthSizeMode = System.Windows.Forms.DataGridViewRowHeadersWidthSizeMode.DisableResizing;
			...
			this.apptDataGrid.RowTemplate.Height = 80;
			this.apptDataGrid.RowTemplate.Resizable = System.Windows.Forms.DataGridViewTriState.True;
