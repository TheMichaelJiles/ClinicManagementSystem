...
namespace ClinicManagementSystem.View.UserControls
{
	public partial class PatientAppointmentsControl : UserControl
	{
		...
		public Appointment SelectedAppointment => this.appointments[this.apptDataGrid.SelectedRows[0].Index];
		...
		{
			var patientApptFrm = new AppointmentInfoPage(this) { IsCreatingAppointment = true };
